...
// Array
#define mems(a, x) memset(a, x, nof(a))      // Works only for 0 and -1
#define ass_vel(ar, n, x) fo(i, n) ar[i] = x // Set value in array
#define a_sort(ar, n) sort(ar, ar + n)
#define d_sort(arr, n) sort(arr, arr + n, greater<int>())
#define min_el(arr, n) *min_element(arr, arr + n)
#define max_el(arr, n) *max_element(arr, arr + n)
