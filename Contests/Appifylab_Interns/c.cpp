...
#define pop_cnt(n) __builtin_popcount(n) // Assign it to a value to find the nbers of 1's
                                         // in a binary nber
#define nBits(n) log2(n) + 1             // Assign it to a value to get the nber of bits
                                         // in an integer
#define Digitn(n) log10(n) + 1           // Assign it to a value to get the nber of digits
                                         // in an integer
