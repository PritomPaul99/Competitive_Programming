...
#define strIn(name_of_the_string) getline(cin, name_of_the_string)                       // string input with spaces or use *gets()*
#define strIn_(name_of_the_string) getline(cin, name_of_the_string, delimiter_character) // Takes string input until a certain character
